...
//// From here, all cards should use field names from different types of cards
    ...
    vector<Card> board1 = &p1.pBoard;
    vector<Card> board2 = &p2.pBoard;
    
    for (int i = 0; i < board1.size(); i++) {
        string temptype = board1[i].getType();
